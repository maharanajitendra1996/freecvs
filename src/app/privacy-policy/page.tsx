  ...
  return (
    <SiteShell>
      <article className="prose prose-zinc mx-auto max-w-3xl px-4 py-12">
        ...
        <ul>
          <li>
            Resume content: information you enter in the editor, stored locally
            in your browser.
          </li>
          <li>
            Usage data: pages visited and download actions for improving our
            service.
          </li>
        </ul>
        ...
        <p>
          Resume drafts stored in your browser can be cleared anytime via
          browser settings (local storage).
        </p>
        <h2>Contact</h2>
        <p>
